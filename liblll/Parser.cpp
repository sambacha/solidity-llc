...
template <unsigned N> struct tagNode
{
	void operator()(sp::utree &n,
	                qi::rule<string::const_iterator, qi::ascii::space_type, sp::utree()>::context_type &c) const
	{
...
void dev::lll::parseTreeLLL(string const &_s, sp::utree &o_out)
{
	...
	qi::rule<it, string()> intstr
	    = qi::lexeme[qi::no_case["0x"][qi::_val = "0x"] >> +qi::char_("0-9a-fA-F")[qi::_val += qi::_1]]
	...
	qi::rule<it, space_type, sp::utree()> atom
	    = integer[qi::_val = qi::_1] | (str | strsh)[qi::_val = qi::_1] | symbol[qi::_val = qi::_1];
	...
	qi::rule<it, space_type, sp::utree()> extra = sload[tagNode<2>()] | mload[tagNode<1>()] | sstore[tagNode<4>()]
	                                              | mstore[tagNode<3>()] | seq[tagNode<5>()]
	                                              | calldataload[tagNode<6>()];
